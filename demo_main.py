...
class Test(MDApp):
    ...
    # loads the kivy file
    def build(self):
        my_app = Builder.load_file("demo.kv")
        ...
        scrolling_layout = FloatLayout(
            size_hint = (1, 0.35 * len(stream_urls))
        )
        ...
        for num in range((stream_count := len(stream_urls))):
            ...
            if(stream_urls[num] == "example1.mp4" or stream_urls[num] == "example2.mp4"):
                stream_choices[num].background_normal = stream_urls[num][:-4] + ".png"
